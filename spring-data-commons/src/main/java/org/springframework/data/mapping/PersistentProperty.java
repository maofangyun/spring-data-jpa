...
public interface PersistentProperty<P extends PersistentProperty<P>> {
	...
	/**
	 * Returns the component type of the type if it is a {@link Collection}. Will return the type of the key if
	 * the property is a {@link Map}.
	 *
	 * @return the component type, the map's key type or {@literal null} if neither {@link Collection} nor
	 *         {@link Map}.
	 */
	@Nullable
