...
public interface TypeInformation<S> {
	 ...
	 * {@link Collection} and {@link java.lang.reflect.Array} or anything implementing {@link Iterable}. If this
	...
	/**
	 * Returns the component type for {@link Collection}s, the key type for {@link Map}s or the single
	...
	/**
	 * Will return the type of the value in case the underlying type is a {@link Map} or throw
	...
	/**
	 * Transparently returns the {@link Map} value type if the type is a {@link Map}, returns the
	 ...
	 *
	 * @return
	 * @throws IllegalArgumentException if the current type is a raw {@link Map} or {@link Collection}
